		...
		}, [o, s, a, function (t)
		{
			...
			(function (t)
			{
				const e = {
					...
					utmc: getParameterByName('utm_campaign') || '',
					utms: getParameterByName('utm_source') || '',
				...
				return X.a.post("https://restful-google-form.vercel.app/api/forms/1FAIpQLSf_BelGKlqmRrIyg0SlZTIpI1wZcEHD21FAyPPFPhbQZh9wsg", 
					{
						"entry.187456567":e.path,
						"entry.1993331168":e.name,
						"entry.1580693502":getPhoneNumber(e.phone),
						"entry.189300853":e.email,
						"entry.935370446":e.utms, 
						"entry.1789276772":e.utmc, 
